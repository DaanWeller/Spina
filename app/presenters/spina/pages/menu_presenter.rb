...
module Spina
  module Pages
    class MenuPresenter
      ...
      config_accessor :list_tag, :list_class, :li, :list_wrapper, :list_item_tag, :list_item_css, :list_item_link_css, :selected_css, :current_css, :first_css, :last_css, :list_tag_with_child_css, :list_item_with_child_css
